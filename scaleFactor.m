% function to compute the spatial scaling factor, temporal scaling factor
% and scale-specific factor
% x1 and x2 are two dynamics with the same number of units, but potential different length of time (row for neuron and colomn for time)
